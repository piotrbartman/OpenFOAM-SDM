...
void Foam::SDMCollision<CloudType>::collide
(
...
template<class CloudType>
bool Foam::SDMCollision<CloudType>::collideParcels
(
    const scalar dt,
    parcelType& p1,
    parcelType& p2,
...
template<class CloudType>
bool Foam::SDMCollision<CloudType>::collideSorted
(
    const scalar dt,
    parcelType& p1,
    parcelType& p2,
...
template<class CloudType>
Foam::SDMCollision<CloudType>::SDMCollision
(
...
Foam::SDMCollision<CloudType>::SDMCollision
(
    const SDMCollision<CloudType>& cm
)
:
